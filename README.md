...
```
  git clone https://github.com/zuhebahmed88091/Tasker.git
```

- Navigate to the location of the folder in your machine:

you@your-Pc-name:~$ cd Tasker
...
- For more information, check [Vercel](https://vercel.com) website.
...
Feel free to check the [issues page](https://github.com/zuhebahmed88091/Tasker/issues).
